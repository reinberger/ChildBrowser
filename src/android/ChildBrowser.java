...
public class ChildBrowser extends Plugin {
	...
	public String showWebPage(final String url, JSONObject options) {
		...
		if (options != null) {
			showLocationBar = options.optBoolean("showLocationBar", true); // display the whole location bar
			showNavigationBar = options.optBoolean("showNavigationBar", true); // display navigation buttons
			showAddress = options.optBoolean("showAddress", true); // display address text field
		}
